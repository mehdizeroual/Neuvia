...
import { communityExperiences } from "@/lib/mock-data";
...
export default function CommunityExperiencesPage() {
  ...
  const filteredExperiences = filterExperiences(communityExperiences);
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-neutral-600 dark:text-neutral-400">
            Expériences créées par les professeurs de la communauté Neuvia
          </p>
        </div>
